...
@XmlType(name = "nalog", propOrder = { "idPoruke", "duznik", "svrhaPlacanja",
		"primalac", "datumNaloga", "datumValute", "racunDuznik",
		"modelZaduzenja", "pozivNaBrZaduzenja", "racunPoverioca",
		"modelOdobrenja", "pozivNaBrOdobrenja", "iznos", "oznakaValute",
		"hitno" })
public class Nalog {
