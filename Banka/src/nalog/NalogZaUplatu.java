...
@WebService(
		targetNamespace = "http://ftn.uns.ac.rs/banka"
		)
...
public interface NalogZaUplatu {
	...
	public String obradiNalog(@WebParam(name="nalog", targetNamespace="http://ftn.uns.ac.rs/nalog")Nalog nalog);//, targetNamespace="http://ftn.uns.ac.rs/nalog")Nalog nalog);
